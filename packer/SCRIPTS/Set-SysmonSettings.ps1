...
$SysmonFolder = "$Env:SystemDrive\windows"
$SysmonBinary = "sysmon.exe"
$ConfigFolder = "$Env:SystemDrive\windows\temp\sysmon-config"
...
Try
{
  ...
  & $SysmonBinary -accepteula -i $ConfigFolder\sysmonconfig-export.xml
}
Catch
{
